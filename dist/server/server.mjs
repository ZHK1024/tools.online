import { effectScope, shallowReactive, reactive, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, version, unref, h, shallowRef, isReadonly, isRef, ref, isShallow, isReactive, toRaw, computed, defineComponent, Fragment, createVNode, Text, defineAsyncComponent, provide, Suspense, nextTick, mergeProps, Transition, watch, withCtx, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
...
const _routes = [
  {
    ...
    path: "/base-converter",
    component: () => import("./static/index-CMqhsviX.js")
  },
  {
  ...
  },
  {
    name: "base64___en",
    path: "/base64",
    component: () => import("./static/index-DOt7zBuW.js")
  },
  {
    name: "base64___zh",
    path: "/zh/base64",
  ...
  },
  {
    name: "hmac___en",
    path: "/hmac",
    component: () => import("./static/index-XqbnWHQS.js")
  },
  {
    name: "hmac___zh",
    path: "/zh/hmac",
  ...
  },
  {
    name: "index___en",
    path: "/",
    component: () => import("./static/index-CnTEdrbI.js")
  },
  {
    name: "index___zh",
    path: "/zh",
  ...
  },
  {
    name: "md5___en",
    path: "/md5",
    component: () => import("./static/index-AOEQGkwa.js")
  },
  {
    name: "md5___zh",
    path: "/zh/md5",
  ...
  },
  {
    name: "url-coder___en",
    path: "/url-coder",
    component: () => import("./static/index-CpoOAMgE.js")
  },
  {
    name: "url-coder___zh",
    path: "/zh/url-coder",
  ...
  },
  {
    ...
    path: "/url-parser",
    component: () => import("./static/index-SbskmGh8.js")
  },
  {
...
function updateSiteConfig(input = {}) {
  var _a;
  {
    ...
    stack == null ? void 0 : stack.push(input);
    return;
  }
}
...
const vueI18nConfigs = [
  () => import(
    "./static/i18n.config-DiOOU_7p.js"
...
const layouts = {
  default: defineAsyncComponent(() => import("./static/default-B56by8dv.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./static/error-404-L6kEjsf-.js"));
    const _Error = defineAsyncComponent(() => import("./static/error-500-DLzZEB4H.js"));
