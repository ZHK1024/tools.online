import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/ruris/Documents/GitHub/tools100-nuxt/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { getQuery, createError, appendResponseHeader, getResponseStatus, getResponseStatusText } from 'file:///Users/ruris/Documents/GitHub/tools100-nuxt/node_modules/h3/dist/index.mjs';
import { stringify, uneval } from 'file:///Users/ruris/Documents/GitHub/tools100-nuxt/node_modules/devalue/index.js';
...
import { renderToString } from 'file:///Users/ruris/Documents/GitHub/tools100-nuxt/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file:///Users/ruris/Documents/GitHub/tools100-nuxt/node_modules/@unhead/ssr/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file:///Users/ruris/Documents/GitHub/tools100-nuxt/node_modules/unhead/dist/index.mjs';
import { version, unref } from 'file:///Users/ruris/Documents/GitHub/tools100-nuxt/node_modules/vue/index.mjs';
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"google-adsense-account","content":"ca-pub-3737189245877678"}],"link":[],"style":[],"script":[{"innerHTML":"\n            const theme = localStorage.getItem('vueuse-color-scheme') || 'light';\n            if (theme === 'dark' || theme === 'auto') {\n              document.documentElement.classList.add('dark');\n            } else {\n              document.documentElement.classList.remove('dark');\n            }\n          ","type":"text/javascript"},{"src":"https://www.googletagmanager.com/gtag/js?id=G-5BX6MWT297","async":true},{"children":"\n              window.dataLayer = window.dataLayer || [];\n              function gtag(){dataLayer.push(arguments);}\n              gtag('js', new Date());\n              gtag('config', 'G-5BX6MWT297');\n          "}],"noscript":[]};
