import { hasInjectionContext, inject, version, unref, defineComponent, h, getCurrentInstance, ref, defineAsyncComponent, computed, provide, shallowReactive, watch, Suspense, nextTick, Fragment, Transition, mergeProps, useSSRContext, createApp, effectScope, reactive, getCurrentScope, toRef, isRef, shallowRef, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, isReadonly, Text, withCtx, isShallow, isReactive, toRaw } from 'file:///Users/ruris/Documents/GitHub/tools100-nuxt/node_modules/vue/index.mjs';
import { $fetch } from 'file:///Users/ruris/Documents/GitHub/tools100-nuxt/node_modules/ofetch/dist/node.mjs';
...
import { sanitizeStatusCode, createError as createError$1, appendHeader, getRequestHeaders, getRequestHeader, setCookie, getCookie, deleteCookie } from 'file:///Users/ruris/Documents/GitHub/tools100-nuxt/node_modules/h3/dist/index.mjs';
import { getActiveHead, CapoPlugin } from 'file:///Users/ruris/Documents/GitHub/tools100-nuxt/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/ruris/Documents/GitHub/tools100-nuxt/node_modules/@unhead/shared/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/ruris/Documents/GitHub/tools100-nuxt/node_modules/vue-router/dist/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file:///Users/ruris/Documents/GitHub/tools100-nuxt/node_modules/radix3/dist/index.mjs';
import { defu } from 'file:///Users/ruris/Documents/GitHub/tools100-nuxt/node_modules/defu/dist/defu.mjs';
...
import { parse as parse$1 } from 'file:///Users/ruris/Documents/GitHub/tools100-nuxt/node_modules/cookie-es/dist/index.mjs';
import { isEqual as isEqual$1 } from 'file:///Users/ruris/Documents/GitHub/tools100-nuxt/node_modules/ohash/dist/index.mjs';
import { setupDevtoolsPlugin } from 'file:///Users/ruris/Documents/GitHub/tools100-nuxt/node_modules/vue-devtools-stub/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs } from 'file:///Users/ruris/Documents/GitHub/tools100-nuxt/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "base-converter___en",
    path: "/base-converter",
    component: () => import('./index-CMqhsviX.mjs')
  },
  {
    name: "base-converter___zh",
    path: "/zh/base-converter",
    component: () => import('./index-CMqhsviX.mjs')
  },
  {
    name: "base64___en",
    path: "/base64",
    component: () => import('./index-DOt7zBuW.mjs')
  },
  {
    name: "base64___zh",
    path: "/zh/base64",
  ...
  },
  {
    name: "hmac___en",
    path: "/hmac",
    component: () => import('./index-XqbnWHQS.mjs')
  },
  {
    name: "hmac___zh",
    path: "/zh/hmac",
  ...
  },
  {
    name: "index___en",
    path: "/",
    component: () => import('./index-CnTEdrbI.mjs')
  },
  {
    name: "index___zh",
    path: "/zh",
  ...
  },
  {
    name: "md5___en",
    path: "/md5",
    component: () => import('./index-AOEQGkwa.mjs')
  },
  {
    name: "md5___zh",
    path: "/zh/md5",
  ...
  },
  {
    name: "url-coder___en",
    path: "/url-coder",
    component: () => import('./index-CpoOAMgE.mjs')
  },
  {
    name: "url-coder___zh",
    path: "/zh/url-coder",
  ...
  {
    name: "url-parser___en",
    path: "/url-parser",
    component: () => import('./index-SbskmGh8.mjs')
  },
  {
    name: "url-parser___zh",
    path: "/zh/url-parser",
    component: () => import('./index-SbskmGh8.mjs')
  }
];
...
function updateSiteConfig(input = {}) {
  var _a;
  {
    const stack = (_a = useRequestEvent()) == null ? undefined : _a.context.siteConfig;
    stack == null ? undefined : stack.push(input);
    return;
  }
}
...
const i18n_server_JnOCBC9QIO = /* @__PURE__ */ defineNuxtPlugin({
...
const vueI18nConfigs = [
  () => import(
    './i18n.config-DiOOU_7p.mjs'
    /* webpackChunkName: "__i18n_config_bffaebcb" */
  )
];
...
function getDomainFromLocale(localeCode) {
  ...
  const domain = ((_b = (_a = config == null ? undefined : config.locales) == null ? undefined : _a[localeCode]) == null ? undefined : _b.domain) || (lang == null ? undefined : lang.domain) || ((_e = (_d = (_c = config == null ? undefined : config.locales) == null ? undefined : _c[localeCode]) == null ? undefined : _d.domains) == null ? undefined : _e.find((v) => v === host)) || ((_f = lang == null ? undefined : lang.domains) == null ? undefined : _f.find((v) => v === host));
  if (domain) {
  ...
  async setup(nuxt) {
    ...
    if (multiDomainLocales && (strategy === "prefix_except_default" || strategy === "prefix_and_default")) {
      ...
      router.getRoutes().forEach((route2) => {
        var _a;
        if ((_a = route2.name) == null ? undefined : _a.toString().includes("___default")) {
...
const plugins = [
  ...
  i18n_server_JnOCBC9QIO,
  switch_locale_path_ssr_5csfIgkrBP,
  i18n_sq1MuCrqbC,
  prerender_server_LXx1wM9sKF
];
const layouts = {
  default: defineAsyncComponent(() => import('./default-B56by8dv.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const _Error404 = defineAsyncComponent(() => import('./error-404-L6kEjsf-.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DLzZEB4H.mjs'));
...
export { _export_sfc as _, navigateTo as a, useNuxtApp as b, useRuntimeConfig as c, withoutTrailingSlash as d, entry$1 as default, useI18n as e, useRoute as f, useLocaleHead as g, hasProtocol as h, injectHead as i, joinURL as j, resolveUnrefHeadInput as k, nuxtLinkDefaults as n, parseQuery as p, resolveRouteObject as r, useRouter as u, withTrailingSlash as w };
