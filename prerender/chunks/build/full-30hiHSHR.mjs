...
import { ssrRenderAttrs, ssrRenderSlot, ssrRenderComponent } from 'file:///Users/ruris/Documents/GitHub/tools100-nuxt/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main$1 = {
  ...
  methods: {
    loadAdsense() {
      const adsbygoogle = (undefined).createElement("script");
      adsbygoogle.async = true;
      adsbygoogle.src = "https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js";
      (undefined).head.appendChild(adsbygoogle);
      const adUnit = (undefined).createElement("ins");
      ...
      ((undefined).adsbygoogle = (undefined).adsbygoogle || []).push({});
      this.showAd = true;
    }
  }
};
...
//# sourceMappingURL=full-30hiHSHR.mjs.map
